...
////                std::cout<<joint_limits_[i][0]<<" "<<joint_limits_[i][1]<<std::endl;
//                joint_limits_[i][0] = joint_limits_[i][0] - 1.0;
//                joint_limits_[i][1] = joint_limits_[i][1] + 1.0;
////                std::cout<<joint_limits_[i][0]<<" "<<joint_limits_[i][1]<<std::endl;
//            }
...
//            wrist_pos_obj_l_.setZero();
//            wrist_pose_obj_l_.setZero();
