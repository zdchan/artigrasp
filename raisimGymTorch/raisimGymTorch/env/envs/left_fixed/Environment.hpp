...
namespace raisim {
    ...
    public:
        ...
        explicit ENVIRONMENT(const std::string& resourceDir, const Yaml::Node& cfg, bool visualizable) :
            ...
            final_pose_l_.setZero(nJoints_), final_obj_pos_b_.setZero(7), final_ee_pos_r_.setZero(num_bodyparts*3), final_vertex_normals_r_.setZero(num_contacts*3), contact_body_idx_r_.setZero(num_contacts), final_contact_array_r_.setZero(num_contacts);
        ...
        final {
            raisim::Vec<4> quat_goal_hand_w, quat_goal_hand_l, quat_obj_init_t, quat_obj_init_b;
            ...
            raisim::quatInvQuatMul(quat_obj_init_t, quat_goal_hand_w, quat_goal_hand_l);  //修改
            raisim::quatToRotMat(quat_goal_hand_l, rotm_goal_hand_l);
        ...
        float* step(const Eigen::Ref<EigenVec>& action_r, const Eigen::Ref<EigenVec>& action_l) final {
            ...
            if (motion_synthesis)
            {
                ...
                raisim::matmul(Obj_ori_test, rotm_goal_hand_l, rotm_goal_hand_w);
        ...
        void updateObservation() {
            ...
            for(int i = 0; i < num_bodyparts ; i++){
                ...
                if (i==0)
                {
                    ...
                    raisim::Vec<3> angular_vel_l, angular_vel_r, vel_l, vel_r;
...
//
            ...
            raisim::Vec<3> trans_l;
            raisim::Mat<3,3> rot_l;
            raisim::Vec<4> quat_l;
