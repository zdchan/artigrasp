...
weight_saved = '2023-05-08-10-03-19/full_2000_l.pt'
...
for update in range(args.num_iterations):
    ...
    if record:
        ...
        data['left_hand'] = {}
        data['waffleiron'] = {}
        data['left_hand']['trans'] = np.float32(trans_r)
        data['left_hand']['rot'] = np.float32(rot_r)
        data['left_hand']['pose'] = np.float32(pose_r)
        ...
        np.save(f"./data_all/recorded/ours_fixed/{obj_name}_fixed_left.npy", data)
        print("recorded")
